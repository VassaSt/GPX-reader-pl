  ...
  <script>
      ...
      window.addEventListener("message", async function (e) {
          ...
          if (e.data.handle) {
              ...
              // Save property geolocation date 
              if (userproperty) {
      ...
      function addMarkers(features) {
          ...
          features.forEach(function (feature) {
              ...
              pointText = feature.properties.name;
  
              // converting coordinates into string
              pointLatToString = pointLat.toString();
              pointLngToString = pointLng.toString();
  
              // making text explanation using coordinates string for new marker
              function labelTextlocation(x, y) {
                  x = pointLatToString;
                  y = pointLngToString;
                  return "Marker_lat: " + x + "_lng: " + y;
              }
